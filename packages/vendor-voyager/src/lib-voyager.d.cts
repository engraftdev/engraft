...
export declare function renderVoyager(container: Element, store: Store<State>): void;
export declare function updateDataAction(data: InlineData): {
    type: string;
    payload: {
        name: string;
        schema: import("../node_modules/compassql/build/src/schema").Schema;
        data: InlineData;
    };
};
